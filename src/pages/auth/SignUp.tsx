  ...
  const signUpWithGoogle = async () => {
    try {
      ...
      const { data, error } = await supabase.auth.signInWithOAuth({
        provider: 'google',
        options: {
          redirectTo: 'https://tagteam.co.in/auth/callback',
          queryParams: {
            access_type: 'offline',
            prompt: 'consent',
          }
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="text-center">
            <CardTitle>Join TagTeam</CardTitle>
            <CardDescription>Create your account to find accountability partners</CardDescription>
          </CardHeader>
          <CardContent>
            <Button 
              type="button" 
              ...
              className="w-full flex items-center justify-center gap-2 py-6 border-2 text-base"
            >
