...
const WelcomeScreen: React.FC = () => {
  ...
  return <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6">
      <div className="w-[90%] max-w-md bg-[#F0F0FF] rounded-[20px] border border-[#E6E6FF] p-6 flex flex-col items-center">
        ...
        {/* CTA Button */}
        <Button onClick={() => navigate('/signup')} className="w-[85%] h-14 bg-black text-white rounded-full font-medium text-base shadow-sm hover:bg-black/90 transition-colors mt-auto">
          Get Started
        </Button>
      </div>
    </div>;
