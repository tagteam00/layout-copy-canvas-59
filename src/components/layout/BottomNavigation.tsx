...
const BottomNavigation: React.FC = () => {
  ...
  return <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-gray-100/10 rounded-t-lg bg-[#0f0f11] py-[8px]">
      <div className="max-w-[480px] mx-auto px-4">
        <div className="flex items-center justify-center gap-10 py-3">
          <NavLink to="/home" onClick={handleNavigation} className={({
          isActive
          ...
          <NavLink to="/tagteam" onClick={handleNavigation} className={({
          isActive
        }) => cn("flex flex-col items-center justify-center gap-1", isActive ? "text-[#8B83FF]" : "text-gray-400")}>
          ...
          <NavLink to="/profile" onClick={handleNavigation} className={({
          isActive
        }) => cn("flex flex-col items-center justify-center gap-1", isActive ? "text-[#8B83FF]" : "text-gray-400")}>
