...
export const TagTeamList: React.FC<TagTeamListProps> = ({
  ...
  if (loading) {
    return (
      <section className="flex w-full flex-col text-black mt-5 px-4 my-0">
      ...
      {teams.length === 0 ? (
        <div className="flex flex-col items-center justify-center text-gray-500 w-full space-y-5 py-0 my-[8px]">
          ...
          <Button
            ...
            onClick={onAddTeam}
            size="lg"
            className="w-full max-w-[448px] mx-4 mt-0 text-base font-semibold bg-black text-white rounded-xl py-0 my-[8px]"
          >
