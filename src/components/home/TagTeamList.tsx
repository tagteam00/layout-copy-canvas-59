...
export const TagTeamList: React.FC<TagTeamListProps> = ({
  ...
  return <section className="flex w-full flex-col text-black mt-5 px-4 my-[17px]">
      ...
      {teams.length === 0 ? <div className="flex flex-col items-center justify-center text-gray-500 w-full space-y-5 py-[24px]">
        ...
        fontSize: 18
          ...
          {teams.map(team => <TagTeamCard key={team.id} {...team} onCardClick={() => handleCardClick(team)} />)}
        </div>}
